...
namespace JPushiOSLibrary
{
	...
	interface JPUSHService
	{
		...
		void SetTagsTarget(NSSet tags, string alias, Selector cbSelector, NSObject theTarget);
		...
		void SetTagsObject(NSSet tags, string alias, Selector cbSelector, NSObject theTarget);
